...
wget https://github.com/cryptopp-modern/cryptopp-modern/releases/download/2026.9.1/cryptopp-modern-2026.9.1.zip
unzip cryptopp-modern-2026.9.1.zip -d cryptopp-modern
cd cryptopp-modern
...
```bash
# Download and extract cryptopp-modern-2026.9.1.zip
...
1. Download and extract cryptopp-modern-2026.9.1.zip
