		...
		DEFINE_OID(member_body()+840, iso_us)
			...
			DEFINE_OID(iso_us()+113549, rsadsi)
				DEFINE_OID(rsadsi()+1, pkcs)
					...
					DEFINE_OID(pkcs()+9, pkcs_9)
					DEFINE_OID(pkcs_9()+16, smime)
						DEFINE_OID(smime()+3, smime_alg)
							// HSS/LMS hash-based signatures (RFC 8554, RFC 8708)
							DEFINE_OID(smime_alg()+17, id_alg_hss_lms_hashsig)
